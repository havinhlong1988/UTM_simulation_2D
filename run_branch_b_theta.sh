...
s "06b costmap (econ/air/ground on the 05 network)"; $PY 06b_costmap_thetastar.py
s "07b sim (pass 1, assessed costmap)";              $PY 07b_simulate_thetastar_scheduling.py
s "06b costmap (+ measured pass-1 traffic)";         $PY 06b_costmap_thetastar.py
s "07b sim (pass 2, full costmap)";                  $PY 07b_simulate_thetastar_scheduling.py
